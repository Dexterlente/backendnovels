...
url = 'http://127.0.0.1:8000/api/novel/list-latest/'
...
if response.status_code == 200:
    ...
    for chapter in chapter_list.chapters:
        print(f"Novel ID: {chapter.novel_id}, Novel Title: {chapter.novel_title}, Title: {chapter.title}, Timestamp: {chapter.timestamp}, Index: {chapter.index} , Subchapter: {chapter.subchapter}")
else:
